    ...
    <Card className='w-full md:max-w-[30vw] p-5'>
            <div className='text-center flex items-center flex-col gap-3 py-3'>
                <div className='relative'>
                    <Image src={profile} alt='profile Image' width={120} className='z-10'/>
               ...
               <div className='w-full flex flex-col gap-2'>
                    ...
                    <div className='flex items-center'>
                        <p className='text-muted-foreground'>⚡ Literally responds in 24hrs</p>
                    </div>
               </div>
            ...
            <div className='mt-4 flex flex-col gap-2'>
                ...
                {languages.map((item, index) => (
                    <div key={index} className={`${item.width} flex items-center justify-center rounded-full px-2 py-[1px] border dark:bg-secondary/70 dark:hover:bg-secondary hover:bg-secondary cursor-pointer backdrop-blur-sm`}>
                        <p>{item.label}</p>
                    </div>
                ))}
                </div>
            ...
            <div className='mt-4 flex flex-col gap-3'>
                ...
                <p className='text-muted-foreground'>Hi there 👋, I'm Caleb a front-end engineer with 4 years of experience. I build professional, high performance websites with perfect SEO practices.
                    <br />
                </p>
                <div>
                ...
                <div className='mt-5 flex items-center gap-2 border-t py-3'>
                    ...
                    <div>
                        <div>
                          <p>Founder at <strong>Calcade Solutions Inc.</strong></p>
                          <Link href="https://calcade.vercel.app" className='flex gap-1 items-center underline'>
                            <Link2 size={16}/>
                            calcade.vercel.app
                          </Link>
                        </div>
